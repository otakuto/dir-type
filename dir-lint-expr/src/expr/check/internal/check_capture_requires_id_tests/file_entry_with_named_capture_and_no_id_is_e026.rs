...
use crate::expr::check::internal::check_capture_requires_id::check_capture_requires_id;
use dir_lint_error::SemanticError;
use dir_lint_yaml::{PatternSpec, RegexPattern, RuleName, YamlEntry, YamlEntryKind, YamlPattern};
