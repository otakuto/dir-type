use crate::expr::check::internal::check_with_compat::check_with_compat;
use crate::expr::check::internal::id_shape_derive::build_id_shapes;
use dir_lint_error::SemanticError;
use dir_lint_yaml::{EntryId, PatternSpec, RuleName, YamlEntry, YamlEntryKind, YamlPattern};
