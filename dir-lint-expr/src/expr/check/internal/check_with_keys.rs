...
use dir_lint_yaml::{RuleName, YamlEntry, YamlEntryKind, YamlRule};
...
mod tests {
    use super::*;
    use dir_lint_yaml::{RuleName, VarName, YamlEntry, YamlEntryKind, YamlPattern, YamlRule};
    use indexmap::IndexMap;
    ...
    fn make_rule_with_with(keys: &[&str]) -> YamlRule {
        ...
        for key in keys {
            ...
            with_params.insert(
                ...
                dir_lint_yaml::YamlWithShape(serde_yaml::Value::Null),
            );
        }
        YamlRule {
