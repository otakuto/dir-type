use crate::template_ref::strip_braces;
use crate::{ExprEntry, ExprForSource, ExprMatcher, ExprPattern, ExprSubtree, MatchArm, Quant};
use dir_lint_yaml::{YamlEntry, YamlEntryKind, YamlForSource, YamlPattern};
